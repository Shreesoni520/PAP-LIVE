...
/* lista de tarefas (sem limit, paginação client-side) – novas primeiro */
$tarefas = [];
$res = $conn->query("SELECT * FROM states ORDER BY id DESC");
while ($row = $res->fetch_assoc()) {
    $tarefas[] = $row;
}

/* números para paginação visual */
...
<div id="app">
    ...
    <div id="main">
        ...
        <div class="page-heading-custom mb-3">
            ...
            <p class="text-subtitle text-muted mb-0">Lista de tarefas.</p>
        </div>
                            ...
                            <div class="mb-2">
                                ...
                                <select id="filterTarefa" class="form-select js-nice-select">
                                    ...
                                    <?php if ($total_states > 0): ?>
                                        <?php
                                        $allStates = $conn->query("SELECT name FROM states ORDER BY id DESC");
