...
<head>
  ...
  <title>Ocorrências de Estrada</title>
    ...
    <div class="container h-100 d-flex align-items-center justify-content-center">
      <div class="row w-100 gy-0 align-items-center justify-content-center">
        <div class="container section-title" data-aos="fade-up" style="margin-top: 5%;">
          <h2>Ocorrências de estrada registadas</h2>
          <p>Consulte as ocorrências de estrada registadas no sistema e visualize a sua localização e tarefa.</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4">
          <?php while ($ocor = $ocorrencias->fetch_assoc()):
            ...
            $imagemPath = !empty($ocor['imagem'])
              ? "/PAP/uploads/ocorrencias_estrada/" . htmlspecialchars($ocor['imagem'], ENT_QUOTES, 'UTF-8')
              ...
              <div class="ocor-card">
                ...
                <div class="ocor-card-img-wrapper">
                  <img
                    ...
                    data-bs-target="#imagemModalEstrada<?= (int)$ocor['id'] ?>"
                  >
                </div>

                <div class="modal fade" id="imagemModalEstrada<?= (int)$ocor['id'] ?>" tabindex="-1" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title">Imagem da ocorrência de estrada</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                      <div class="modal-body text-center">
                        <img
                          src="<?= $imagemPath ?>"
                          alt="Imagem da ocorrência de estrada"
                          class="img-fluid"
          ...
          <nav aria-label="Navegação de páginas" class="mt-4">
            <ul class="pagination justify-content-center ocor-pagination">
              <?php if ($paginaAtual > 1): ?>
                <li class="page-item">
                  <a class="page-link"
                     href="index.php?evora_p=listarocorrenciasestrada&page=<?= $paginaAtual - 1 ?>#ocorrencias"
              ...
              <?php for ($p = 1; $p <= $totalPaginas; $p++): ?>
                <li class="page-item <?= $p == $paginaAtual ? 'active' : '' ?>">
                  <a class="page-link"
                     href="index.php?evora_p=listarocorrenciasestrada&page=<?= $p ?>#ocorrencias">
                    <?= $p ?>
                  </a>
                </li>
              <?php endfor; ?>
      ...
      <?php else: ?>
        <div class="ocor-empty text-center">
          ...
          <h5 class="mb-1">Ainda não existem ocorrências de estrada</h5>
          <p class="text-muted mb-0">
            Quando forem registadas ocorrências nas estradas, aparecerão aqui com a respetiva localização e tarefa.
          </p>
        </div>
      <?php endif; ?>
